 ...
 */
export function buildGradePrompt(axes: TestAxes, statics: Record<string, number>, goal: GoalKey): { system: string; user: string } {
  ...
  const user =
    `The photo is a ${rows}×${cols} laser test grid.\n` +
